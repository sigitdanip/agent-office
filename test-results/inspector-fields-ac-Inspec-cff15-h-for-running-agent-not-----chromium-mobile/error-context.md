...
- Name: inspector-fields-ac.spec.js >> Inspector Field Reliability — AC Validation >> AC3: FileEdited field shows file path for running agent (not "--")
- Location: tests/e2e/inspector-fields-ac.spec.js:109:7
...
Expected: "/root/agent-office/server/routes-ac3.js"
Received: "/tmp/qa_validation.py"
```
